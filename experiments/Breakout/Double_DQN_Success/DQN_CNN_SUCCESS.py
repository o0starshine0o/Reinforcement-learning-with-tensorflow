# https://github.com/zuwang12/workspace/blob/cf701d59630836e05fbd15b40340738709d9945b/tf/tutorials/dqn/config.py
...
from tensorflow.python.keras.layers import (Add, Conv2D, Dense, Flatten, Input,
                                     Lambda, Subtract)
...
class GameWrapper:
    ...
    def reset(self, evaluation=False):
        ...
        self.frame, info = self.env.reset()
        self.last_lives = 0
