...
# 经验回放
MIN_REPLAY_BUFFER_SIZE = 30000  # The minimum size the replay buffer must be before we start to update the agent
MAX_REPLAY_BUFFER_SIZE = 50000  # The maximum size of the replay buffer

# 训练
# Maximum length of an episode (in frames). 10800 frames / 60 fps = 180 second = 3 minute
MAX_TRAIN_EPISODE_FRAMES = 10800
# Number of frames between evaluations, 每次评估之间,训练的帧数
# 前期没什么经验随便选, 每盘就200帧左右, 10盘就2000帧的样子
TRAIN_FRAMES_BETWEEN_EVALUATION = 10000
...
# 评估
EVAL_FRAMES = 10800  # Number of frames to evaluate for, 每次评估需要产生的帧数
