...
# Total number of frames to train for, 总计用于训练的帧数
TOTAL_FRAMES = 300000
...
# 训练
MAX_TRAIN_EPISODE_FRAMES = 18000  # Maximum length of an episode (in frames).  1800 frames / 60 fps = 30 second
TRAIN_FRAMES_BETWEEN_EVALUATION = 100000  # Number of frames between evaluations, 每次评估之间,训练的帧数
